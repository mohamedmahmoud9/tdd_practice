...
import 'package:clean_architecture_practice/features/number_trivia/domain/repositories/number_trivia_repository.dart';
...
void main(){
  ...
  test("Should get trivia for random nubmer from the repository", ()async{
// arrange
